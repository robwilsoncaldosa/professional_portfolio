...
export interface ThemePalette {
  ...
  category?: "signature" | "dark" | "premium" | "company";
...
export const THEME_PALETTES: ThemePalette[] = [
  {
    id: "ink-indigo",
    name: "Ink + Indigo",
    tagline: "Deep ink canvas lit by an indigo spotlight, with a soft periwinkle accent. The trust of navy, without borrowing anyone's teal. Currently live.",
    category: "signature",
  ...
  {
    id: "ink-indigo-deep",
    name: "Ink + Indigo Deep",
    tagline: "Ink + Indigo taken two steps darker: the same indigo spotlight glowing out of near-black.",
    category: "signature",
    swatch: { background: "#080912", card: "#0d0f1c", accent: "#a6b4fc" },
    vars: {
      background: "234 38% 5%",
      foreground: "234 33% 93%",
      card: "234 35% 8%",
      popover: "234 35% 7%",
      secondary: "234 14% 66%",
      muted: "234 27% 13%",
      mutedForeground: "234 12% 48%",
      accentSurface: "234 25% 17%",
      border: "234 25% 15%",
      ring: "230 94% 82%",
      chart2: "220 86% 74%",
      chart3: "245 90% 82%",
      ...
      chart5: "260 84% 80%",
      glowPrimaryRgb: "79, 70, 229",
      pageGradientTop: "#0e1020",
      pageGradientMid: "#080912",
      pageGradientBottom: "#05050b",
    },
  },
  {
    id: "aurora-night",
    name: "Aurora Night",
    tagline: "Indigo spotlight with an icy cyan accent. Two cool hues, like northern lights over ink.",
    category: "signature",
    swatch: { background: "#0a0b15", card: "#0f111f", accent: "#8beaf9" },
    vars: {
      background: "232 36% 6%",
      foreground: "232 33% 93%",
      card: "232 33% 9%",
      popover: "232 33% 8%",
      secondary: "232 14% 66%",
      muted: "232 25% 14%",
      mutedForeground: "232 12% 48%",
      accentSurface: "232 23% 18%",
      border: "232 23% 16%",
      ring: "188 90% 76%",
      chart2: "178 82% 68%",
      chart3: "203 86% 76%",
      ...
      chart5: "218 80% 74%",
      glowPrimaryRgb: "79, 70, 229",
      pageGradientTop: "#101323",
      pageGradientMid: "#0a0b15",
      pageGradientBottom: "#07080e",
    },
  },
  {
    id: "electric-sapphire",
    name: "Electric Sapphire",
    tagline: "Deep sapphire canvas with an electric-blue spotlight and a luminous blue accent. Bold but corporate-safe.",
    category: "signature",
    swatch: { background: "#080d16", card: "#0d1321", accent: "#91c2fd" },
    vars: {
      background: "222 45% 6%",
      foreground: "222 33% 93%",
      card: "222 42% 9%",
      popover: "222 42% 8%",
      secondary: "222 14% 66%",
      muted: "222 34% 14%",
      mutedForeground: "222 12% 48%",
      accentSurface: "222 32% 18%",
      border: "222 32% 16%",
      ring: "213 96% 78%",
      chart2: "203 88% 70%",
      chart3: "228 92% 78%",
      chart4: "193 90% 72%",
      chart5: "243 86% 76%",
      glowPrimaryRgb: "37, 99, 235",
      pageGradientTop: "#0e1525",
      pageGradientMid: "#080d16",
      pageGradientBottom: "#06080f",
    },
  },
  {
    id: "void-violet",
    name: "Void + Electric Violet",
    tagline: "Near-black violet lit by an electric-violet spotlight. The most futuristic, AI-flavored option.",
    category: "signature",
    swatch: { background: "#0d0a14", card: "#14101e", accent: "#c0acfc" },
    vars: {
      background: "258 32% 6%",
      foreground: "258 33% 93%",
      card: "258 29% 9%",
      popover: "258 29% 8%",
      secondary: "258 14% 66%",
      muted: "258 21% 14%",
      mutedForeground: "258 12% 48%",
      accentSurface: "258 19% 18%",
      border: "258 19% 16%",
      ring: "255 92% 83%",
      chart2: "245 84% 75%",
      chart3: "270 88% 83%",
      chart4: "235 86% 77%",
      chart5: "285 82% 81%",
      glowPrimaryRgb: "109, 40, 217",
      pageGradientTop: "#161122",
      pageGradientMid: "#0d0a14",
      pageGradientBottom: "#09070d",
    },
  },
  {
    id: "royal-navy-gold",
    name: "Royal Navy + Gold",
    tagline: "Rich navy under a royal-blue spotlight, with a warm gold accent. Classic, expensive, and it makes the award feel native.",
    category: "signature",
    swatch: { background: "#0a0e19", card: "#101523", accent: "#f7cd64" },
    vars: {
      background: "224 42% 7%",
      foreground: "224 33% 93%",
      card: "224 39% 10%",
      popover: "224 39% 9%",
      secondary: "224 14% 66%",
      muted: "224 31% 15%",
      mutedForeground: "224 12% 48%",
      accentSurface: "224 29% 19%",
      border: "224 29% 17%",
      ring: "43 90% 68%",
      chart2: "33 82% 60%",
      chart3: "58 86% 68%",
      chart4: "23 84% 62%",
      chart5: "73 80% 66%",
      glowPrimaryRgb: "29, 78, 216",
      pageGradientTop: "#101728",
      pageGradientMid: "#0a0e19",
      pageGradientBottom: "#070a12",
    },
  },
  {
    id: "indigo-amber",
    name: "Indigo + Amber",
    tagline: "Ink + Indigo's canvas and spotlight, with a warm amber accent for contrast that pops.",
    category: "signature",
    swatch: { background: "#0c0d18", card: "#111422", accent: "#f9c16c" },
    vars: {
      background: "232 35% 7%",
      foreground: "232 33% 93%",
      card: "232 32% 10%",
      ...
      chart5: "66 82% 68%",
      glowPrimaryRgb: "79, 70, 229",
      pageGradientTop: "#121526",
      pageGradientMid: "#0c0d18",
      pageGradientBottom: "#080911",
    },
  },
  {
    id: "emerald-night",
    name: "Emerald Night",
    tagline: "Deep green-black with an emerald spotlight and a bright mint-green accent. Rich, like a luxury watch dial.",
    category: "signature",
    swatch: { background: "#08120f", card: "#0d1c18", accent: "#7beabe" },
    vars: {
      background: "165 38% 5%",
      foreground: "165 33% 93%",
      card: "165 35% 8%",
      popover: "165 35% 7%",
      secondary: "165 14% 66%",
      muted: "165 27% 13%",
      mutedForeground: "165 12% 48%",
      accentSurface: "165 25% 17%",
      border: "165 25% 15%",
      ring: "156 72% 70%",
      chart2: "146 64% 62%",
      chart3: "171 68% 70%",
      chart4: "136 66% 64%",
      chart5: "186 62% 68%",
      glowPrimaryRgb: "4, 120, 87",
      pageGradientTop: "#0e201b",
      pageGradientMid: "#08120f",
      pageGradientBottom: "#050b09",
    },
  },
  {
    id: "crimson-noir",
    name: "Crimson Noir",
    tagline: "Black-red canvas with a crimson spotlight and a rose-coral accent. Dramatic and confident.",
    category: "signature",
    swatch: { background: "#10090a", card: "#1a0f11", accent: "#f896a3" },
    vars: {
      background: "350 28% 5%",
      foreground: "350 33% 93%",
      card: "350 25% 8%",
      popover: "350 25% 7%",
      secondary: "350 14% 66%",
      muted: "350 17% 13%",
      mutedForeground: "350 12% 48%",
      accentSurface: "350 15% 17%",
      border: "350 15% 15%",
      ring: "352 88% 78%",
      chart2: "342 80% 70%",
      chart3: "7 84% 78%",
      chart4: "332 82% 72%",
      chart5: "22 78% 76%",
      glowPrimaryRgb: "159, 18, 57",
      pageGradientTop: "#1d1113",
      pageGradientMid: "#10090a",
      pageGradientBottom: "#0a0606",
    },
  },
  {
    id: "obsidian-steel",
    name: "Obsidian + Steel",
    tagline: "Near-black with a whisper of blue and a brushed-steel accent. The most restrained of the set.",
    category: "dark",
    swatch: { background: "#090a0b", card: "#101114", accent: "#a2b8cd" },
    vars: {
      background: "220 12% 4%",
      ...
      chart4: "186 20% 62%",
      chart5: "234 20% 76%",
      glowPrimaryRgb: "40, 70, 110",
      pageGradientTop: "#101114",
      pageGradientMid: "#090a0b",
      pageGradientBottom: "#060607",
    },
  },
  {
    id: "carbon-cobalt",
    name: "Carbon + Cobalt",
    tagline: "Carbon black lit by a cobalt spotlight. Confident, technical, and unmistakably engineered.",
    category: "dark",
    swatch: { background: "#0a0c0f", card: "#111318", accent: "#6e9fed" },
    vars: {
      background: "222 18% 5%",
      ...
      secondary: "222 12% 63%",
      muted: "222 14% 13%",
      mutedForeground: "222 8% 46%",
      accentSurface: "222 13% 17%",
      border: "222 13% 15%",
      ring: "217 78% 68%",
      chart2: "205 78% 60%",
      chart3: "229 78% 64%",
      chart4: "193 68% 58%",
      chart5: "241 68% 72%",
      glowPrimaryRgb: "30, 64, 175",
      pageGradientTop: "#111318",
      pageGradientMid: "#0a0c0f",
      pageGradientBottom: "#07080b",
    },
  },
  {
    id: "onyx-titanium",
    name: "Onyx + Titanium",
    tagline: "Pure neutral onyx with a cool titanium accent. Hardware-grade minimalism, no hue at all in the canvas.",
    category: "dark",
    swatch: { background: "#0a0a0a", card: "#121212", accent: "#c2c7cb" },
    vars: {
      background: "0 0% 4%",
      foreground: "0 0% 92%",
      card: "0 0% 7%",
      ...
      chart4: "186 10% 68%",
      chart5: "234 10% 82%",
      glowPrimaryRgb: "90, 100, 118",
      pageGradientTop: "#121212",
  ...
  {
    id: "abyss-silver",
    name: "Abyss Navy + Silver",
    tagline: "Navy so deep it reads as black, with a silver accent. Banker-grade trust, dialed down to midnight.",
    category: "dark",
    swatch: { background: "#07090d", card: "#0c0f17", accent: "#c4c9d4" },
    vars: {
      background: "225 30% 4%",
      ...
      secondary: "225 12% 63%",
      muted: "225 26% 12%",
      mutedForeground: "225 8% 46%",
      accentSurface: "225 25% 16%",
      border: "225 25% 14%",
      ring: "220 15% 80%",
      chart2: "208 15% 72%",
      chart3: "232 15% 76%",
      chart4: "196 10% 70%",
      chart5: "244 10% 84%",
      glowPrimaryRgb: "28, 48, 100",
      pageGradientTop: "#0c0f17",
      pageGradientMid: "#07090d",
      pageGradientBottom: "#040508",
    },
  },
  {
    id: "gunmetal-amber",
    name: "Gunmetal + Whiskey Amber",
    tagline: "Warm gunmetal with an aged-amber accent, like a leather-and-steel study. Sits close to the award gold.",
    category: "dark",
    swatch: { background: "#0e0d0c", card: "#161413", accent: "#dba457" },
    vars: {
      background: "30 8% 5%",
      foreground: "30 8% 92%",
      card: "30 8% 8%",
      ...
      chart4: "11 55% 50%",
      chart5: "59 55% 64%",
      glowPrimaryRgb: "120, 72, 24",
      pageGradientTop: "#161413",
      pageGradientMid: "#0e0d0c",
      pageGradientBottom: "#0a0908",
    },
  },
  {
    id: "black-jade",
    name: "Black Forest + Jade",
    tagline: "Forest-tinted black with a muted jade accent. Calm and grounded, a quieter alternative to blue.",
    category: "dark",
    swatch: { background: "#080c0b", card: "#0f1513", accent: "#86b6a2" },
    vars: {
      background: "160 18% 4%",
      ...
      chart4: "131 15% 52%",
      chart5: "179 15% 66%",
      glowPrimaryRgb: "20, 83, 65",
      pageGradientTop: "#0f1513",
      pageGradientMid: "#080c0b",
      pageGradientBottom: "#050807",
    },
  },
  {
    id: "graphite-crimson",
    name: "Graphite + Crimson",
    tagline: "Graphite black with a deep crimson accent. Bold and decisive, used sparingly it feels like a sports-car interior.",
    category: "dark",
    swatch: { background: "#0e0c0c", card: "#161313", accent: "#da626c" },
    vars: {
      background: "0 6% 5%",
      foreground: "0 8% 92%",
      card: "0 6% 8%",
      ...
      secondary: "0 6% 63%",
      muted: "0 2% 13%",
      mutedForeground: "0 6% 46%",
      accentSurface: "0 1% 17%",
      border: "0 1% 15%",
      ring: "355 62% 62%",
      chart2: "343 62% 54%",
      chart3: "7 62% 58%",
      chart4: "331 52% 52%",
      chart5: "19 52% 66%",
      glowPrimaryRgb: "120, 22, 34",
      pageGradientTop: "#161313",
      pageGradientMid: "#0e0c0c",
      pageGradientBottom: "#090808",
    },
  },
  {
    id: "charcoal-olive",
    name: "Charcoal + Tactical Olive",
    tagline: "Charcoal with a desaturated olive accent. Utilitarian and rugged, still clean.",
    category: "dark",
    swatch: { background: "#0d0e0c", card: "#151613", accent: "#a1ae7a" },
    vars: {
      background: "80 6% 5%",
      foreground: "80 8% 92%",
      card: "80 6% 8%",
      ...
      secondary: "80 6% 63%",
      muted: "80 2% 13%",
      mutedForeground: "80 6% 46%",
      accentSurface: "80 1% 17%",
      border: "80 1% 15%",
      ring: "75 24% 58%",
      chart2: "63 24% 50%",
      chart3: "87 24% 54%",
      chart4: "51 14% 48%",
      chart5: "99 14% 62%",
      glowPrimaryRgb: "70, 82, 40",
      pageGradientTop: "#151613",
      pageGradientMid: "#0d0e0c",
      pageGradientBottom: "#090908",
    },
  },
  {
    id: "abyss-arctic",
    name: "Abyss + Arctic Cyan",
    tagline: "Blue-black depth with a crisp arctic-cyan accent. Cold and precise; the closest of the set to Brittany's teal.",
    category: "dark",
    swatch: { background: "#070b0d", card: "#0c1417", accent: "#6ec7d8" },
    vars: {
      background: "200 30% 4%",
      ...
      chart4: "166 48% 54%",
      chart5: "214 48% 68%",
      glowPrimaryRgb: "14, 90, 112",
      pageGradientTop: "#0c1417",
      pageGradientMid: "#070b0d",
      pageGradientBottom: "#040708",
    },
  },
  {
    id: "warm-graphite",
  ...
  },
  {
    ...
    tagline: "Charcoal gunmetal canvas, a deep steel-blue spotlight, and a cool steel accent. Engineered, confident, and quiet.",
    category: "premium",
...
export const THEME_STORAGE_KEY = "portfolio-theme-vars-v4";
export const THEME_PALETTE_ID_STORAGE_KEY = "portfolio-theme-palette-id-v4";
...
export const THEME_COOKIE_NAME = "portfolio-theme-palette-id-v4";
